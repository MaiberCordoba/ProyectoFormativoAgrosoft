...
import { ControlesModal } from "./ControlesDetallesModal";
  ...
  export const DetalleCultivoModal = ({isOpen,onClose,cultivo,}: DetalleCultivoModalProps) => {
    
    //estado maneja los submodales con detalles (controles,Actividades,cosechas,ventas)
  ...
  const DetailCard = ({ title, count, onClick }: { title: string; count: number; onClick: () => void }) => (
    <div 
